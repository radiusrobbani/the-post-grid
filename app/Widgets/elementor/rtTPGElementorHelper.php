...
class rtTPGElementorHelper {
	 ...
	 * @param $ref
	 */
	public static function grid_layouts( $ref, $prefix = null ) {
		if ( ! $prefix ) {
			$prefix = $ref->prefix;
		}
		$ref->start_controls_section(
		...
		if ( 'slider' === $prefix ) {
			...
			$grid_column_condition = [
				'slider_layout!' => [ 'slider-layout10', 'slider-layout11', 'slider-layout12' ],
			];
		}
		...
		if ( $prefix !== 'slider' ) {
			$layout_align_css = [
				'{{WRAPPER}} .tpg-el-main-wrapper .grid-behaviour .rt-holder .rt-el-content-wrapper'                  => 'justify-content: {{VALUE}};height:100%;',
				...
				'{{WRAPPER}} .tpg-el-main-wrapper .grid-behaviour .rt-holder .rt-el-content-wrapper-flex'             => 'align-items: {{VALUE}};',
			];
		...
		$ref->add_responsive_control(
			$prefix . '_left_side_width',
			[
				'label'      => __( 'Image Wrapper Width', 'the-post-grid' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .rt-tpg-container .grid-layout2 .rt-holder .tpg-el-image-wrap' => 'flex: 0 0 {{SIZE}}{{UNIT}}; max-width: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
	...
	public static function field_selection( $ref ) {
		...
		$ref->add_control(
			'show_author_image',
			[
				'label'        => __( 'Post Author Image', 'the-post-grid' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'the-post-grid' ),
				'label_off'    => __( 'Hide', 'the-post-grid' ),
				'return_value' => 'show',
	...
	public static function section_title_settings( $ref ) {
		$ref->start_controls_section(
		...
		$ref->add_control(
			...
			[
				...
				'default'     => __( 'Section Title', 'the-post-grid' ),
				'label_block' => true,
				'condition'   => [
	...
	public static function post_meta_settings( $ref ) {
		...
		foreach ( $post_types as $post_type => $label ) {
			...
			$ref->add_control(
				$post_type . '_taxonomy',
				[
					'label'       => __( 'Select one as Category', 'the-post-grid' ),
					'type'        => \Elementor\Controls_Manager::SELECT,
					'default'     => $default_cat,
			...
			$ref->add_control(
				$post_type . '_tags',
				[
					'label'       => __( 'Select one as Tags', 'the-post-grid' ),
					'type'        => \Elementor\Controls_Manager::SELECT,
					'default'     => $default_tag,
					'options'     => $term_options,
					'condition'   => [
	...
	public static function metaInfoStyle( $ref ) {
		...
		$ref->add_control(
			'meta_separator_margin',
			[
				'label'              => __( 'Meta Separator Spacing', 'the-post-grid' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => [ 'px', '%', 'em' ],
				'allowed_dimensions' => 'horizontal',
				'default'            => [
				...
				'selectors'          => [
					'{{WRAPPER}} .tpg-post-meta .separator' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	public static function socialShareStyle( $ref ) {
		...
		$ref->add_control(
			...
			[
				...
				'allowed_dimensions' => 'all',
				'selectors'          => [
					'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$ref->add_control(
			...
			[
				...
				'selectors'          => [
					'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$ref->add_control(
			...
			[
				...
				'selectors'          => [
					'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$ref->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a i' => 'width:{{width}}px; height:{{height}}px; line-height:{{height}}px; text-align:center',
				],
		...
		$ref->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a i' => 'color: {{VALUE}}',
				],
				'condition' => [
		...
		$ref->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a i' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'social_icon_style' => 'custom',
				],
		...
		foreach ( $ssList as $ss ) {
			$ref->add_control(
				...
				[
					...
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a.' . $ss . ' i' => 'color: {{VALUE}}',
					],
					'condition' => [
			...
			$ref->add_control(
				...
				[
					...
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a.' . $ss . ' i' => 'background-color: {{VALUE}}',
					],
					'condition' => [
						'social_icon_style' => 'different_color',
					],
		...
		$ref->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a i',
			]
		);
		...
		$ref->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a:hover i' => 'color: {{VALUE}}',
				],
				'condition' => [
					'social_icon_style' => 'custom',
				],
		...
		$ref->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a:hover i' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'social_icon_style' => 'custom',
				],
		...
		foreach ( $ssList as $ss ) {
			$ref->add_control(
				...
				[
					...
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a.' . $ss . ':hover i' => 'color: {{VALUE}}',
					],
					'condition' => [
						'social_icon_style' => 'different_color',
					],
			...
			$ref->add_control(
				...
				[
					...
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a.' . $ss . ':hover i' => 'background-color: {{VALUE}}',
					],
					'condition' => [
						'social_icon_style' => 'different_color',
					],
		...
		$ref->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rt-tpg-container .rt-tpg-social-share a:hover i',
			]
		);
		...
		$ref->end_controls_tabs();
		//TODO: End Social Share Tabs Tab
		...
		if ( 'slider' !== $prefix ) {
			...
			$ref->add_responsive_control(
				...
				[
					...
					'render_type' => 'template',
					'selectors'   => [
						'{{WRAPPER}} .tpg-el-main-wrapper .rt-row [class*="rt-col"]'              => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
						'{{WRAPPER}} .tpg-el-main-wrapper .rt-row'                                => 'margin-left: -{{LEFT}}{{UNIT}}; margin-right: -{{RIGHT}}{{UNIT}}',
						'{{WRAPPER}} .tpg-el-main-wrapper .rt-row .rt-row'                        => 'margin-top: -{{LEFT}}{{UNIT}}; margin-bottom: -{{RIGHT}}{{UNIT}}',
	...
	public static function slider_settings( $ref ) {
		$prefix = $ref->prefix;
		$ref->start_controls_section(
			'slider_settings',
			[
		...
		$ref->add_control(
			'carousel_effect',
			[
				'label'        => __( 'Slider Effect', 'the-post-grid' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'slide',
				'options'      => [
					'slide'     => __( 'Slide', 'the-post-grid' ),
					'fade'      => __( 'fade', 'the-post-grid' ),
				],
			]
		);
		*/
	...
	public static function slider_style( $ref ) {
		$prefix = $ref->prefix;
		$ref->start_controls_section(
			'slider_style',
			[
